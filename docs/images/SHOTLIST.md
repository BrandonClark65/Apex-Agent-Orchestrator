...
| --------------------- | ---------------------------------------------------------------- | -------------------------------------------------------------------- |
| `agent-chat.png`      | `README.md` - hero, above the fold                               | Agent Chat mid-conversation with a tool call and its result          |
...
Two images carry the most weight: `agent-chat.png` is the first thing a visitor sees, and
