...
- **Compare before you commit.** The Test Bench can run a saved input against any published version, so you can put two traces side by side before making one live.
