...
**Current version: 0.3 (0.3.0.1), Released.** This is a promoted managed package version - it can be installed into any org, including production. Testing in a sandbox or scratch org first is still recommended.

Install link: https://login.salesforce.com/packaging/installPackage.apexp?p0=04tfj000000NH9pAAG
